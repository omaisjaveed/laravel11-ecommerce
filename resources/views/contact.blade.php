    ...
    <section class="contact-us container">
      ...
      <div class="mw-930">
        <div class="contact-us__form">
          <form name="contact-us-form" class="needs-validation" action="{{route('user.contact.store')}}" novalidate="" method="POST">
            @csrf
            ...
            <div class="form-floating my-4">
              <input type="email" class="form-control" name="email" name="email" value="{{old('email')}}" placeholder="Email address *" required="">
