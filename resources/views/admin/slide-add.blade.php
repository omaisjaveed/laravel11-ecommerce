...
<div class="main-content-inner">
    ...
    <div class="main-content-wrap">
        ...
        @if (session('status'))
            ...
            @endif
        <div class="wg-box">
            <form action="{{route('admin.slide.store')}}" method="post" enctype="multipart/form-data" class="form-new-product form-style-1">
                @csrf
                <fieldset class="name">
                ...
                <fieldset class="name">
                    <div class="body-title">Tittle <span class="tf-color-1">*</span></div>
                    <input class="flex-grow" type="text" placeholder="Title" name="title"
                        tabindex="0" value="{{old('tagline')}}" aria-required="true" required="">
                </fieldset>
                <fieldset class="name">
                    <div class="body-title">Subtittle <span class="tf-color-1">*</span></div>
